...
public class DebeziumKafkaContainer extends GenericContainer<DebeziumKafkaContainer> {
    ...
    private void defaultconfig() {
        ...
        withEnv("KAFKA_ADVERTISED_LISTENERS", String.format("CONTROLLER://%s,BROKER://%s", getPublicBootstrapAddress(), getBootstrapAddress()));
    ...
    public String getBootstrapAddress() {
        return String.format("%s:%s", getNetworkAliases().getFirst(), KAFKA_BROKER_PORT);
    }
}
